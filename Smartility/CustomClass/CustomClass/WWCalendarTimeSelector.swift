...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = brandColor()
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = brandColor()
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = brandColor()
    ...
    open var optionClockBackgroundColorAMPMHighlight = brandColor()
    ...
    open var optionClockBackgroundColorHourHighlight = brandColor()
    open var optionClockBackgroundColorHourHighlightNeedle = brandColor()
    ...
    open var optionClockBackgroundColorMinuteHighlight = brandColor()
    open var optionClockBackgroundColorMinuteHighlightNeedle = brandColor()
    ...
    open var optionButtonFontColorCancel = brandColor()
    open var optionButtonFontColorDone = brandColor()
    open var optionButtonFontColorCancelHighlight = brandColor().withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = brandColor().withAlphaComponent(0.25)
    open var optionButtonBackgroundColorCancel = UIColor.clear
    open var optionButtonBackgroundColorDone = UIColor.clear
    
    open var optionTopPanelBackgroundColor = brandColor()
    ...
    open var optionSelectorPanelBackgroundColor = brandColor().withAlphaComponent(0.9)
